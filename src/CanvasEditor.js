    ...
    <div className="main-container">
      ...
      <div className="left editor-container">
        <div className="canvas-container">
          <canvas id="canvas" className="scaled-canvas" width="500" height="500"></canvas>
      ...
      <div className="right controls">
        <div className="container">
          ...
          <div className="heading">
            ...
            <div className="sub-heading">Customize your ad and get the templates accordingly</div>
          </div>
          ...
          <div className="image-selector">
            <div>
              ...
              <span className="image-text">Change the ad creative image.</span>
          ...
          <div className="content-selector">
            <div className="input-container">
              ...
              <input type="text" id="caption-input" placeholder="Enter caption"></input>
            </div>
          ...
          <div className="cta-selector">
            <div className="input-container">
              ...
              <input type="text" id="cta-input" placeholder="Enter call to action"></input>
            </div>
          </div>
          ...
          <div className="color-selector">
            <div className="color-picker-container">
              ...
              <input type="color" id="background-color" value="#ffffff"></input>
            </div>
          </div>
        </div>
      </div>
